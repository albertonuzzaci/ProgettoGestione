...
class InfoFrame(ctk.CTkFrame):
	def __init__(self, root, propType, roomType, beds, baths, myfont):
		...
		labelTitleBeds = ctk.CTkLabel(self, text='Beds\n', font=titleFont)
		...
		labelBeds= ctk.CTkLabel(self, text=f'{self.beds}', font=myfont)
		...
		labelTitleBeds.grid(row=0, column=2, sticky="s", padx=5, pady=(5,0))
		...
		labelBeds.grid(row=1, column=2, sticky="n", padx=5, pady=(0,5))
